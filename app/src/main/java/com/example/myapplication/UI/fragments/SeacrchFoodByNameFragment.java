...
import com.example.myapplication.UI.fragments.FoundFoodActivity;
import com.example.myapplication.model.User;


public class SeacrchFoodByNameFragment extends Fragment{
    private SearchView sv;

    private User user;
    private Button btn;
    public static final String TAG = "SeacrchFoodByNameFragment";
    public static SeacrchFoodByNameFragment newInstance(User user) {
        SeacrchFoodByNameFragment fragment = new SeacrchFoodByNameFragment();
